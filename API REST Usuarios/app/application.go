...
// Application implementa la aplicación con patrones de diseño
...
func NewApplication(cfg *config.Config) (*Application, error) {
	...
	logger.Info("Iniciando aplicación con patrones de diseño...")
...
func (app *Application) GetEventPublisher() services.EventPublisher {
